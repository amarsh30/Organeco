...
class DummyAdapter(
    private val dataList: List<DataDummy>) : RecyclerView.Adapter<DummyAdapter.DummyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DummyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            Toast.makeText(holder.itemView.context, "Kamu memilih " + dataList[holder.adapterPosition].name, Toast.LENGTH_SHORT).show()
    ...
    inner class DummyViewHolder(private val binding: ItemFertilizerBinding) : RecyclerView.ViewHolder(binding.root){
